...
react.includes("ভুদা") || 
react.includes("buda") || 
react.includes("galiedj") ||
react.includes("galibazi") ||        react.includes("সাওয়া") || 
...
react.includes("Sawya") || 
react.includes("tor mare xudi") || react.includes("vuda") || react.includes("heda") || react.includes("bapert")) {
		var msg = {
