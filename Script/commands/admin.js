...
module.exports.run = ({ event, api }) => api.sendMessage(`The Bot is Under The Admin  ミ★ 𝘐𝘯𝘧𝘰 ★彡
--------------------------------------------
FACEBOOK : 々ƦαηΑ ΑDཇཇɭ
GENDER : Male
Age : 20+
Relationship : Single
Work : Student
FACEBOOK LINK : https://www.facebook.com/rana.adeel.279`, event.threadID, event.messageID);